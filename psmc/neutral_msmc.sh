...
for CHROM in "${!inverted_regions[@]}"; do
    ...
    if (( INV_END < CHROM_END )); then
        ...
        # Check if the .txt file generated by generate_multihetsep.py is not empty before adding it to the command
        if [[ -s $NEUTRAL_OUT/$(echo "${SAMPLE[indID]}")_${CHROM}_${REGION}.txt ]]; then
            COMMAND="$COMMAND $NEUTRAL_OUT/$(echo "${SAMPLE[indID]}")_${CHROM}_${REGION}.txt"
        else
            echo "Skipping empty file: $NEUTRAL_OUT/$(echo "${SAMPLE[indID]}")_${CHROM}_${REGION}.txt"
...
# Run MSMC2 with the neutral regions (only the ones that passed the previous filter of being not empty)
msmc2_Linux -t 24 -o $NEUTRAL_OUT2/$(echo "${SAMPLE[indID]}") $COMMAND || { echo "Error in MSMC2"; exit 1; }

# Generate MSMC plot R inputs for each sample
# The plot_utils.py and MSMC_plotInput.py cripts have to be in the directory where they're being exectuted
for FINAL in GC129388 GC129389 GC129390 GC129391 GC129392 GC129393 GC129394 GC129395 GC129396 GC129397 GC129398 GC129399 GC129400 GC129401 GC129402 GC129403 GC129404 GC129405 GC129406 GC129407 GC129408 GC129409 GC129410 GC129411 GC129412 GC129413 GC129414 GC129415 GC129416 GC129417 GC129418 GC129419 GC129420 GC129421 GC129422 GC129423 GC129424 GC129425 GC129426 GC129427 GC129428 GC129429 GC129430 GC129431 GC129432 GC129433 GC129434 GC129435 GC129437 GC129438 GC129439 GC129440 GC136078 GC136079 GC136080 GC136081 GC136082 GC136083 GC136084 GC136085 GC136086 GC136087 GC136088 GC136089 GC136090 GC136091 GC136092 GC136093 GC136094 GC136095 GC136096 GC136097 GC136098 GC136099 GC136100 GC136101 GC136102 GC136103 GC136104 GC136105 GC136106 GC136107 GC136108 GC136109 GC136110 GC136111 GC136112 GC136113 GC136114 GC136115 GC136116 GC136117 GC136118 GC136119 GC136120 GC136121 GC136122 GC136123 GC136124 GC136125 GC136126 GC136127 GC136128; do
