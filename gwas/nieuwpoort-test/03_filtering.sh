...
vcftools --gzvcf merged_Npt.vcf.gz --max-missing 0.9 --minQ 30 --maf 0.05 --remove-indels --recode --stdout | bgzip > gwas_filtered_Npt.vcf.gz
...
# Index VCF file
tabix -p vcf gwas_filtered_Npt.vcf.gz
