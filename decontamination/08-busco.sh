...
busco -i sorted_prim_dud.fasta -m genome -l archaea -c 24
busco -i sorted_prim_dud.fasta -m genome -l fungi -c 24
busco -i sorted_prim_dud.fasta -m genome -l bacteria -c 24
